defmodule ClawEngine.Spaces do
  @moduledoc """
  ...
  @spec reload_engine_config() :: {:ok, ClawEngine.Engine.Snapshot.t()} | {:error, term()}
  ...
  defp agents_service do
    Application.get_env(:claw_engine, :agents_service, Agents)
  end

  defp registry do
    Application.get_env(:claw_engine, :engine_registry, ClawEngine.Engine.Registry)
  end
end
