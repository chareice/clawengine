defmodule ClawEngineWeb.ChatSocket do
  @moduledoc false
  ...
  defp normalize_timeout_ms(_value), do: ClawEngine.Config.openclaw_chat_timeout_ms()
  ...
  defp chat_service do
    Application.get_env(:claw_engine, :chat_service, ClawEngine.Chat)
  end
end
