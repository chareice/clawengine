defmodule OpenClawZalify do
  ...
  - embedded: a host application starts the engine with `runtime: false`
    and includes `OpenClawZalify` in its own supervision tree
  """

  @default_supervisor_name OpenClawZalify.Supervisor
  ...
  def version do
    case Application.spec(:openclaw_zalify, :vsn) do
      nil -> "0.0.0"
  ...
  def migrations_path do
    Application.app_dir(:openclaw_zalify, "priv/repo/migrations")
  end
  ...
  @spec repo() :: module()
  def repo do
    Application.get_env(:openclaw_zalify, :repo, OpenClawZalify.Repo)
  end
  ...
  defp fetch_boolean_option(opts, key, default) do
    Keyword.get(opts, key, Application.get_env(:openclaw_zalify, key, default))
  end
end
