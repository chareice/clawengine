defmodule OpenClawZalify.Engine.Registry do
  @moduledoc """
  ...
  alias OpenClawZalify.Engine.Loader
  ...
  @spec list_spaces() :: {:ok, [OpenClawZalify.Engine.Space.t()]}
  def list_spaces do
    {:ok, snapshot().spaces |> Map.values() |> Enum.sort_by(& &1.id)}
  end

  @spec get_space(String.t()) :: {:ok, OpenClawZalify.Engine.Space.t() | nil}
  ...
  @spec get_model_profile(String.t() | nil) ::
          {:ok, OpenClawZalify.Engine.ModelProfile.t() | nil}
