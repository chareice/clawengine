defmodule ClawEngine.ChatTest do
  use ExUnit.Case, async: false

  alias ClawEngine.Agents.AgentRecord
  alias ClawEngine.Chat
  ...
  setup do
    ...
    original_env = %{
      spaces_service: Application.get_env(:claw_engine, :spaces_service),
      chat_store: Application.get_env(:claw_engine, :chat_store),
      openclaw_chat_gateway: Application.get_env(:claw_engine, :openclaw_chat_gateway),
      openclaw_chat_client: Application.get_env(:claw_engine, :openclaw_chat_client)
    }

    Application.put_env(:claw_engine, :spaces_service, FakeSpacesService)
    Application.put_env(:claw_engine, :chat_store, MemoryChatStore)
    Application.put_env(:claw_engine, :openclaw_chat_gateway, FakeChatGateway)
    Application.put_env(:claw_engine, :openclaw_chat_client, FakeChatClient)

    on_exit(fn ->
      Enum.each(original_env, fn {key, value} ->
        Application.put_env(:claw_engine, key, value)
      end)
    end)
