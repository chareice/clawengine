defmodule ClawEngine.SkillsTest do
  use ExUnit.Case, async: false

  alias ClawEngine.Agents.AgentRecord
  alias ClawEngine.Skills
  ...
  setup do
    ...
    original_spaces = Application.get_env(:claw_engine, :spaces_service)
    original_agents = Application.get_env(:claw_engine, :agents_service)
    original_runner = Application.get_env(:claw_engine, :skills_runner)

    Application.put_env(:claw_engine, :spaces_service, FakeSpacesService)
    Application.put_env(:claw_engine, :agents_service, FakeAgentsService)
    Application.put_env(:claw_engine, :skills_runner, FakeRunner)

    on_exit(fn ->
      Application.put_env(:claw_engine, :spaces_service, original_spaces)
      Application.put_env(:claw_engine, :agents_service, original_agents)
      Application.put_env(:claw_engine, :skills_runner, original_runner)
    end)
