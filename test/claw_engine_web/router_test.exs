defmodule ClawEngineWeb.RouterTest do
  ...
  setup do
    original_probe = Application.get_env(:claw_engine, :openclaw_probe)
    ...
    on_exit(fn ->
      Application.put_env(:claw_engine, :openclaw_probe, original_probe)
  ...
  test "GET /ready returns not ready when the gateway token is missing" do
    ...
    Application.put_env(:claw_engine, :openclaw_probe, SuccessProbe)
  ...
  test "GET /ready returns not ready when the probe fails" do
    System.put_env("OPENCLAW_GATEWAY_URL", "ws://127.0.0.1:18789")
    System.put_env("OPENCLAW_GATEWAY_TOKEN", "secret-token")
    Application.put_env(:claw_engine, :openclaw_probe, FailureProbe)
