defmodule OpenClawZalify.ConfigTest do
  ...
  setup do
    ...
    original_load_env_file = Application.get_env(:openclaw_zalify, :load_env_file, true)

    Application.put_env(:openclaw_zalify, :load_env_file, false)

    on_exit(fn ->
      Application.put_env(:openclaw_zalify, :load_env_file, original_load_env_file)
