defmodule OpenClawZalify.Skills.ClawHubRunnerTest do
  use ExUnit.Case, async: true

  alias OpenClawZalify.Skills.ClawHubRunner
  ...
  test "search_skills parses slug name and score from clawhub output" do
    ...
    original_config = Application.get_env(:openclaw_zalify, ClawHubRunner, [])

    Application.put_env(:openclaw_zalify, ClawHubRunner, command_prefix: [script_path])

    on_exit(fn ->
      Application.put_env(:openclaw_zalify, ClawHubRunner, original_config)
