defmodule OpenClawZalifyWeb.ChatSocketTest do
  ...
  setup do
    original_chat_service = Application.get_env(:openclaw_zalify, :chat_service)
    Application.put_env(:openclaw_zalify, :chat_service, FakeChatService)

    on_exit(fn ->
      Application.put_env(:openclaw_zalify, :chat_service, original_chat_service)
    end)
